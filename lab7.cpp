...
//go left and left then print
//come back print then go right 
//print right
			if(curr==NULL)return;		
			else{
				displayin(curr->left);
...
//Now we will calculate height of a tree  or subtree
